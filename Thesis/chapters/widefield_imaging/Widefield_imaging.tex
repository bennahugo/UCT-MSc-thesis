...
\begin{figure}[h]
  \begin{mdframed}
    ...
    \begin{subfigure}[b]{0.40\textwidth}
      ...
      \caption{}
    \end{subfigure}
    \caption[Apparent shift in source position and resulting decorrelation]{In (a) the apparent source positions of several hourly-interval snapshots  on
    the VLA at 7 declinations is plotted by Rick Perley \cite[Lecture 19]{taylor1999synthesis}. The dots of the zero hour angle is indicated on the vertical 
