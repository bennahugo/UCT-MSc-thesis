...
In w-projection, the resampling cost can be related to the size of the produced images, where as in traditional faceting the cost rise with the number of facets. Unlike w-projection, faceting 
